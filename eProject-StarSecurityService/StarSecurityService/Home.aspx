<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Home.aspx.cs" Inherits="Default2" Title="Untitled Page"  ResponseEncoding="utf-8"%>

<%-- Add content controls here --%><asp:Content ID="Content1" runat="server" 
    contentplaceholderid="ContentPlaceHolder1">
     <span id="tabid" style="display:none">menu1</span>
    <form id="form1" style="width: 947px" title="">
               <!DOCTYPE html>
<html><head>
...
<div style="left:191px; top:150px" class="tooltip-down">													
<div class="tooltip">	  
	  <h2>
    ...
    <div style="left:508px; top:135px" class="tooltip-down">													
    ...
    <div style="left:433px; top:240px" class="tooltip-up">													
        <br />
    <div style="display: none;" class="tooltip">	  
	  <h2>
    ...
    <div style="left:601px; top:115px" class="tooltip-down">													
    <div style="display: none;" class="tooltip">	  
	  <h2>
    ...
    <asp:Image ID="Image1" runat="server" Height="440px" 
        ImageUrl="~/images/img1.jpg" Width="959px" />
