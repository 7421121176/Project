<%@ Page Language="C#" MasterPageFile="~/admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="AdminCompany.aspx.cs" Inherits="Companyt" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"> 
    ...
    <p>
        ...
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:image ID="Image1" runat="server" Height="200px" ImageUrl="~/images/main.png" 
...
&nbsp;
        <asp:ImageButton ID="btnEdit" runat="server" Height="32px" 
            onclick="btnEdit_Click" ToolTip="Edit" ImageUrl="~/images/edit.png" />
